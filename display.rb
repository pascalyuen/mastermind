...
module Display
  def display_intro
    ...
    puts 'A black key peg indicates the existence of a code peg placed in both correct color and position.'
    puts 'A white key peg indicates the existence of a correct color code peg placed in the wrong position.'
